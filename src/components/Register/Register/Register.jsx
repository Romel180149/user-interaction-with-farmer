...
const handleAddUser = e =>{
  ...
  // const salect = form.salect.value;
  const role = form.role.value;
  const user = {firstName,lastName,email,phone,password,role}
...
.then(data=>{
  ...
  return (
   ...
   <div className="w-full mt-8">
        ...
        {/* Role selection (farmer, user, admin) */}
        <select
          className={`w-full p-3 ${darkMode ? "bg-gray-800 text-white" : "bg-gray-200 text-black"}`}
          {...register("role", { required: "Role is required" })}
        >
          <option value="role" name='role' disabled>Select your role</option>
          ...
          <option value="admin" name='admin'>Admin</option>
            ...
            <button type="" value='' className="mt-5 tracking-wide font-semibold bg-[#E9522C] text-gray-100 w-full py-4 rounded-lg hover:bg-[#E9522C]/90 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
              <svg
